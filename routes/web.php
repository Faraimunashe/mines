...
Route::group(['middleware' => ['auth', 'role:client']], function () {
    ...
    //consults
    Route::get('/client/consults', 'App\Http\Controllers\client\ConsultantController@index')->name('client-consults');
    Route::post('/client/consult', 'App\Http\Controllers\client\ConsultantController@consult')->name('client-consult');
